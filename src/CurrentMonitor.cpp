...
void CurrentMonitor::check()
{
	...
	if ((this->current > this->currentSampleMax && digitalRead(signalPin) == HIGH) || (digitalRead(EmergencyStop) == LOW))
	{
		DCCpp::powerOff();
    Serial.println("Power OFF ! Surcharge en courant détectée *****"); 		// PC
    Serial.print("Courant lu : ");
