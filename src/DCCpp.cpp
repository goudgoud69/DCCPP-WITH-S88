...
#if defined(USE_S88)
  Serial.print(F("\nS88_Clock_PIN:   ")); Serial.println(S88_Clock_PIN);
  Serial.print(F("S88_Load_PS_PIN: ")); Serial.println(S88_LOAD_PS_PIN);
  Serial.print(F("S88_Reset_PIN:   ")); Serial.println(S88_Reset_PIN);
  Serial.print(F("S88_DataL_PIN:   ")); Serial.println(S88_DataL_PIN);
  Serial.print(F("S88_DataR_PIN:   ")); Serial.println(S88_DataR_PIN);
#endif
